...
make_helper( concat(add_i2r0_, SUFFIX) )
{
...
make_helper( concat(add_r2rm_, SUFFIX) )
{
	...
	if (m.mod != 3)
	{
		...
		concat(set_SF_, SUFFIX) (value);
		concat(set_PF_, SUFFIX) (value);
		concat(set_CF_, SUFFIX) (mem_v, reg_v, 0);
		concat(set_OF_, SUFFIX) (mem_v, reg_v, 0);
	...
	{  
		...
		concat(set_SF_, SUFFIX) (value);
		concat(set_PF_, SUFFIX) (value);
		concat(set_CF_, SUFFIX) (s_reg_v, d_reg_v, 0);
		concat(set_OF_, SUFFIX) (s_reg_v, d_reg_v, 0);
...
make_helper( concat(add_rm2r_, SUFFIX) )
{
	...
	if (m.mod != 3)
	{
		...
		concat(set_SF_, SUFFIX) (value);
		concat(set_PF_, SUFFIX) (value);
		concat(set_CF_, SUFFIX) (d_reg_v, s_mem_v, 0);
		concat(set_OF_, SUFFIX) (d_reg_v, s_mem_v, 0);

		print_asm("add" str(SUFFIX) " %s,%%%s", ModR_M_asm, REG_NAME(d_reg_i));
