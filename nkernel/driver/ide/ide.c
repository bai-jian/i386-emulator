...
/* The loader acts as a monolithic kernel
 * therefore we do not need to translate the address ``buf'' from the user process to a physical one, 
 * which is necessary for a microkernel.
 */
